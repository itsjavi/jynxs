// Definitions based on Preact https://github.com/preactjs/preact/blob/master/src/jsx.d.ts
...
declare global {
  namespace JSX {
    ...
    type ComponentDOM = HTMLElement | DocumentFragment

    interface Component {
      _dom: HTMLElement | DocumentFragment | null

      componentWillMount? (element: ComponentDOM, props: ElementChildrenAttribute, propKeys: string[]): void

      componentDidMount? (element: ComponentDOM, props: ElementChildrenAttribute, propKeys: string[]): void

      render (): Element
    }

    interface Element extends ElementAttributesProperty, ElementTypeProperty {
    ...
    interface ElementAttributesProperty {
      props: ElementChildrenAttribute;
    }
    ...
    type DOMCSSProperties = {
      [key in keyof Omit<CSSStyleDeclaration,
        | 'item'
        | 'setProperty'
        | 'removeProperty'
        | 'getPropertyValue'
        | 'getPropertyPriority'>]?: string | number | null | undefined;
    };
    ...
    type TargetedAnimationEvent<Target extends EventTarget> = TargetedEvent<Target,
      AnimationEvent>;
    type TargetedClipboardEvent<Target extends EventTarget> = TargetedEvent<Target,
      ClipboardEvent>;
    type TargetedCompositionEvent<Target extends EventTarget> = TargetedEvent<Target,
      CompositionEvent>;
    type TargetedDragEvent<Target extends EventTarget> = TargetedEvent<Target,
      DragEvent>;
    type TargetedFocusEvent<Target extends EventTarget> = TargetedEvent<Target,
      FocusEvent>;
    type TargetedKeyboardEvent<Target extends EventTarget> = TargetedEvent<Target,
      KeyboardEvent>;
    type TargetedMouseEvent<Target extends EventTarget> = TargetedEvent<Target,
      MouseEvent>;
    type TargetedPointerEvent<Target extends EventTarget> = TargetedEvent<Target,
      PointerEvent>;
    type TargetedTouchEvent<Target extends EventTarget> = TargetedEvent<Target,
      TouchEvent>;
    type TargetedTransitionEvent<Target extends EventTarget> = TargetedEvent<Target,
      TransitionEvent>;
    type TargetedUIEvent<Target extends EventTarget> = TargetedEvent<Target,
      UIEvent>;
    type TargetedWheelEvent<Target extends EventTarget> = TargetedEvent<Target,
      WheelEvent>;
